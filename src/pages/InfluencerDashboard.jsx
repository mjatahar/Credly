...
import { ArrowRight, TrendingUp, AlertTriangle, CheckCircle2, Eye, Clock, Users, Sparkles, Target, BarChart3, } from "lucide-react";
// Mock creator data
const creatorData = {
    name: "Priya Sharma",
    handle: "@priyacreates",
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-card rounded-2xl p-6 border border-border/60 shadow-card">
                ...
                <div className="space-y-4">
                  {scoreBreakdown.map((item) => (<CompatibilityMeter key={item.label} label={item.label} score={item.score}/>))}
                </div>
              </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-card rounded-2xl p-6 border border-border/60 shadow-card">
                ...
                <div className="space-y-3">
                  {workingInFavor.map((item) => (<InsightCard key={item.title} title={item.title} description={item.description} icon={item.icon} variant="positive"/>))}
                </div>
              </div>
              ...
              <div className="bg-card rounded-2xl p-6 border border-border/60 shadow-card">
                ...
                <div className="space-y-3">
                  {hesitations.map((item) => (<InsightCard key={item.title} title={item.title} description={item.description} icon={item.icon} variant="warning"/>))}
                </div>
