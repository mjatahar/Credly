        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex justify-center mb-12">
            <div className="inline-flex p-1 rounded-xl bg-secondary">
              <button onClick={() => setActiveTab("influencer")} className={`flex items-center gap-2 px-6 py-3 rounded-lg text-sm font-medium transition-all ${activeTab === "influencer"
            ? "bg-card text-foreground shadow-sm"
            : "text-muted-foreground hover:text-foreground"}`}>
                <User className="w-4 h-4"/>
                For Creators
              </button>
              <button onClick={() => setActiveTab("brand")} className={`flex items-center gap-2 px-6 py-3 rounded-lg text-sm font-medium transition-all ${activeTab === "brand"
            ? "bg-card text-foreground shadow-sm"
            : "text-muted-foreground hover:text-foreground"}`}>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-16">
            {plans.map((plan) => (<div key={plan.name} className={`relative bg-card rounded-2xl p-6 border shadow-card cursor-pointer transition-all duration-300 hover:scale-[1.02] ${plan.popular
                ...
                <div className="mb-6">
                  ...
                  {plan.savings && (<span className="text-sm text-trust-high font-medium">{plan.savings}</span>)}
                </div>
                ...
                <Button variant={plan.popular ? "accent" : "outline"} className="w-full">
                  Get Started
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-secondary/30 rounded-2xl p-8 border border-border/40 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-6">
                {freeFeatures.map((feature) => (<span key={feature} className="px-3 py-1.5 rounded-full bg-card text-sm text-muted-foreground border border-border/60">
                    {feature}
                  </span>))}
              </div>
