...
import { ArrowRight, Search, Filter, Users, Target, TrendingUp, AlertCircle, CheckCircle2, Plus, ChartLine, Briefcase, Activity, Sparkles, } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-card rounded-2xl p-6 border border-border/60 shadow-card">
                ...
                <div className="space-y-4">
                  {campaignHealth.map((campaign) => (<div key={campaign.name} className="flex items-center justify-between p-4 rounded-xl bg-secondary/30 border border-border/40">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <h4 className="font-medium text-foreground">{campaign.name}</h4>
                          <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${campaign.status === "on-track"
              ...
              <div className="bg-card rounded-2xl p-6 border border-border/60 shadow-card">
                ...
                <div className="space-y-3">
                  {attentionItems.map((item) => (<InsightCard key={item.title} title={item.title} description={item.description} icon={item.icon} variant={item.variant}/>))}
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-card rounded-2xl p-6 border border-border/60 shadow-card">
                ...
                <div className="space-y-3">
                  {trustDistribution.map((tier) => (<div key={tier.range} className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className={`w-3 h-3 rounded-full ${tier.label === "Excellent"
                ? "bg-trust-high"
