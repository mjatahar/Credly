...
import { ArrowRight, CheckCircle2, AlertTriangle, BookOpen, Shield, Star, ThumbsUp, Bookmark, X, Sparkles, } from "lucide-react";
// Mock campaign data
const campaign = {
    id: "1",
    brand: "GlowNaturals",
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-card rounded-2xl p-6 border border-border/60 shadow-card">
                ...
                <div className="space-y-3">
                  {fitReasons.map((reason) => (<InsightCard key={reason.title} title={reason.title} description={reason.description} icon={reason.icon} variant={reason.variant}/>))}
                </div>
              </div>
              ...
              <div className="bg-card rounded-2xl p-6 border border-border/60 shadow-card">
                ...
                <div className="space-y-5">
                  {brandIndicators.map((indicator) => (<div key={indicator.label}>
              ...
              <div className="bg-card rounded-2xl p-6 border border-border/60 shadow-card">
                ...
                <ul className="space-y-3">
                  {considerations.map((item, index) => (<li key={index} className="flex items-start gap-3 text-sm">
