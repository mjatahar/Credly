    ...
    return (<section className="py-20 lg:py-28 bg-secondary/30">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {roleCards.map((role) => (<div key={role.id} className="group bg-card rounded-2xl p-8 border border-border/60 shadow-card hover:shadow-card-hover hover:border-accent/30 transition-all duration-300">
              ...
              <ul className="space-y-4 mb-8">
                {role.features.map((feature) => (<li key={feature.label} className="flex items-start gap-3">
