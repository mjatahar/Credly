...
export function HeroSection() {
    return (<section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: "0.3s" }}>
            ...
            "No feedback loops",
        ].map((item) => (<li key={item} className="flex items-start gap-2 text-sm text-muted-foreground">
